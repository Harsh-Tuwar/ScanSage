										...
										<Card.Content>
											...
											<View style={{ flex: 1, flexDirection: 'row', flexWrap: 'wrap' }}>
												{product.ingredients_analysis_tags.map((tag, index) => {
													...
													let tagIconStr = tagString;

													if (tagString.includes('may')) {
														tagIconStr = tagString.split(' ')[2];
													}
													
													const tagIcon = INGREDIENT_TAG_ICONS_MAP[tagIconStr.split(' ')[0] as keyof typeof INGREDIENT_TAG_ICONS_MAP] as any;
